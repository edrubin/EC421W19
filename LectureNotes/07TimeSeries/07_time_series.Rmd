...
1. **Normality of disturbances**, _i.e._, $u_i\overset{\text{iid}}{\sim}\mathop{N}\left( 0,\,\sigma^2 \right)$.
---
layout: true
# Time-series models
## Model options
...
Estimate long-run effects by summing lags, _e.g._, $\beta_1 + \beta_2 + \beta_3 + \beta_4$.
...
\begin{aligned}
 ...
 & + \beta_4 \text{Births}_t + \beta_5 \text{Births}_{\color{#FFA500}{t-1}} + \beta_6 \text{Births}_{\color{#FFA500}{t-2}} + u_t
\end{aligned}
$$
---
layout: true
