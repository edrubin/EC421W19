...
Imagine a (null) hypothesis which states that $\beta_1$ is equal to some value $c$, _i.e._, $H_0:\: \beta_1 = c$
...
```{R, simulation t plot, echo = F, dev = "svg"}
ggplot(data = t_density, aes(x = x, ymin = 0, ymax = y)) +
geom_ribbon(fill = "darkslategray", alpha = 0.8) +
