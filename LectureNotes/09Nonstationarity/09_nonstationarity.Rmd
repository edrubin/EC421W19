...
.center[
$\mathop{\boldsymbol{E}}\left[ x_t \right]  = \mathop{\boldsymbol{E}}\left[ e_{t-k} \right]$ for all $k$
]
--
...
H.sub[o]: $y_t = \beta_0 + \beta_1 y_{t-1} + u_t$ with $|\beta_2|<1$ (.hi[stationarity])
<br>
H.sub[a]: $y_t = y_{t-1} + \varepsilon_t$ (.hi[random walk])

--

using a *t* test that $|\beta_2|<1$.<sup>.pink[†]</sup>

.footnote[
.pink[†] People often just test $\beta_2<1$.
]
