...
venn1_df <- tibble(
  x = c(0.0,   -0.5,    1.5,   -1.0, -2.5),
  y = c(0.0,   -2.5,   -1.8,    2.0, -2.5),
  r = c(1.9,    1.5,    1.5,    1.3,  1.3),
  l = c("Y", "X[1]", "X[2]", "X[3]",  "Z")
)
# Venn
ggplot(data = venn1_df, aes(x0 = x, y0 = y, r = r, fill = l, color = l)) +
geom_circle(alpha = 0.3, size = 0.75) +
theme_void() +
theme(legend.position = "none") +
scale_fill_viridis(discrete = T, option = "C", begin = 0.1, end = 0.95) +
scale_color_viridis(discrete = T, option = "C", begin = 0.1, end = 0.95) +
geom_text(aes(x = x, y = y, label = l), size = 9, family = "Fira Sans Book", parse = T) +
coord_equal()
```
---
class: clear
...
venn2_df <- tibble(
  x = c(0.0,   -0.5,    1.5,   -1.0, -2.5),
  y = c(0.0,   -2.5,   -1.8,    2.0, -1.3),
  r = c(1.9,    1.5,    1.5,    1.3,  1.3),
  l = c("Y", "X[1]", "X[2]", "X[3]",  "Z")
)
# Venn
ggplot(data = venn2_df, aes(x0 = x, y0 = y, r = r, fill = l, color = l)) +
geom_circle(alpha = 0.3, size = 0.75) +
theme_void() +
theme(legend.position = "none") +
scale_fill_viridis(discrete = T, option = "C", begin = 0.1, end = 0.95) +
...
venn3_df <- tibble(
  x = c(0.0,   -0.5,    1.5,   -1.0, -2.5),
  y = c(0.0,   -2.5,   -1.8,    2.0,  0.5),
  r = c(1.9,    1.5,    1.5,    1.3,  1.3),
  l = c("Y", "X[1]", "X[2]", "X[3]",  "Z")
)
# Venn
ggplot(data = venn3_df, aes(x0 = x, y0 = y, r = r, fill = l, color = l)) +
geom_circle(alpha = 0.3, size = 0.75) +
theme_void() +
theme(legend.position = "none") +
scale_fill_viridis(discrete = T, option = "C", begin = 0.1, end = 0.95) +
